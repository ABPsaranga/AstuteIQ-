...
export default function OverridePanel({ finding, reviewId, existingOverride, onClose, onOverrideSubmitted }) {
    const [status, setStatus] = useState(existingOverride?.newStatus ?? finding.status);

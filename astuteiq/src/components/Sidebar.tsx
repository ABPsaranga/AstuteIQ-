    ...
    <aside className="w-64 shrink-0 h-screen sticky top-0 flex flex-col overflow-hidden" style={{ background: '#060810', borderRight: '1px solid rgba(255,255,255,0.055)' }}>
      ...
      {user && (
        <div className="shrink-0 p-3" style={{ borderTop: '1px solid rgba(255,255,255,0.055)' }}>
          <div
            className="flex items-center gap-3 p-3 rounded-2xl transition-all duration-200 hover:bg-white/[0.04] cursor-pointer"
          ...
          >
            ...
            {/* Settings dot */}
            <Settings size={14} className="text-slate-700 hover:text-slate-400 transition-colors shrink-0" />
          </div>
        </div>
      )}
    </aside>

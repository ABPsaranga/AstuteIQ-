...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 shrink-0 h-screen sticky top-0 flex flex-col overflow-hidden select-none" style={{ background: '#060810', borderRight: '1px solid rgba(255,255,255,0.055)' }}>
      ...
      <div className="relative h-16 flex items-center px-5 shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.055)' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[9px] tracking-[0.3em] uppercase text-slate-600 mt-1 font-sans">SOA Compliance</p>
          </div>
        </div>
      ...
      {/* ── Navigation ── */}
      <nav className="relative flex-1 overflow-y-auto py-4 px-3 space-y-1 no-scrollbar" style={{ scrollbarWidth: 'none' }}>
                      ...
                      {({ isActive: active }) => (
                        <>
                          ...
                          {item.badge && (
                            ...
                            >
                              {item.badge === 'LIVE'
                                ? <span className="flex items-center gap-1"><Radio size={7} className="animate-pulse text-emerald-400" />{item.badge}</span>
                                : item.badge
                              }
                            </span>
                          )}
